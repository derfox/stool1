...
app.get('_api/entry',async c => {
  try {
    const { handle } = await import("./endpoints/entry_GET.js");
...
app.post('_api/entry',async c => {
  try {
    const { handle } = await import("./endpoints/entry_POST.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.get('_api/entries',async c => {
  try {
    const { handle } = await import("./endpoints/entries_GET.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.get('_api/data/export',async c => {
  try {
    const { handle } = await import("./endpoints/data/export_GET.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.post('_api/data/import',async c => {
  try {
    const { handle } = await import("./endpoints/data/import_POST.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.post('_api/entry/delete',async c => {
  try {
    const { handle } = await import("./endpoints/entry/delete_POST.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.post('_api/entry/update',async c => {
  try {
    const { handle } = await import("./endpoints/entry/update_POST.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
